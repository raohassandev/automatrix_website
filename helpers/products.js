...
const doors = {
  ...
  single_door: {
    ...
    desPartTwo:
      'We manufacture an extensive selection of sliding Single doors here at Windows Direct and, as they are tailored to your individual requirements and offered in a range of finishes, you can be sure that we will have the perfect door for you amongst our collection. Complete with a 10 year insurance backed guarantee, you can rest assured that our doors are built to last and offer complete security for your property.\nOur dedicated team of experts perform installations of the most superior standard, guaranteeing a precise fit and flawless functionality. We work with you throughout the entire process, from your initial thoughts and ideas to custom manufacture and, finally, completion.\nSo what are you waiting for? Give the experts at Windows Direct a call today for more information or visit our showroom in Croydon.',
  },
  bi_folding_door: {
...
export const PRODUCTS = {
  ...
  glazing: {
    ...
    articles: glazing,
    image: glazing.triple_glazing.image,
  },
  schuco: {
    schuco: 'schuco',
    articles: schuco,
    image: schuco.schuco.image,
  },
};
