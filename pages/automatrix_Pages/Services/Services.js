...
export const Services = () => {
  ...
  return (
    <Fragment>
      <LayoutOne>
        <Breadcrumb bgImg={bgImg} title={'Offered Services'} />
            ...
            <div className='container'>
              <div className='row'>
                ...
                <div className='col-12'>
                  ...
                  <a href='/automatrix_Pages/Services/PvController'>
                    <h4 className='title'>
                      <a href='/automatrix_Pages/Services/PvController'>
                  ...
                  <a href='/automatrix_Pages/Services/EnergyMonitoring'>
                  ...
                  <a href='/automatrix_Pages/Services/ScadaSystem'>
                    <h4 className='title'>
                  ...
                  <a href='/automatrix_Pages/Services/GeneratorSync'>
                    <h4 className='title'>
